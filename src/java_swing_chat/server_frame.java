...
public class server_frame extends javax.swing.JFrame {
   ...
   ArrayList<DataOutputStream> clientDataOutputStreams;
   ...
   public class ClientHandler implements Runnable {
       ...
       @Override
       public void run() {
            String message, connect = "Connect", disconnect = "Disconnect", chat = "Chat", allUsers = "All users", file = "File" ;
            String[] data;
            ...
            try {
                while ((message = reader.readLine()) != null) {
                    ...
                    } else if (data[2].equals(allUsers)) {
                        tellCurrentUser(client, ("" + ":" + String.join(", ", users) + ":" + allUsers));
    ...
    public void tellCurrentUser(PrintWriter client, String message) {
        try {
